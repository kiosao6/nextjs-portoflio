...
import { CallToActionButton, MainStack, Marquee, SelectedProjects } from "@/components";
  ...
  return (
    <main className="h-screen ">
      <section className="px-8 lg:px-0 mb-16 max-w-7xl mx-auto lg:flex">
        <div>
          <p className="text-[80px] mt-12 max-w-4xl mb-6 font-medium leading-tight tracking-[-0.07em] lg:text-[140px] lg:leading-none">I&apos;m Gabriel Maestre.</p>
