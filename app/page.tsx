    ...
    <main>
      <section className="px-8 mt-12 xl:px-0 mb-12 max-w-7xl mx-auto lg:flex">
        <div>
          ...
          <h1 className="tracking-tight leading-7 text-[15px] mb-6 lg:text-xl lg:leading-[34px] max-w-3xl text-neutral-600">I create modern web applications and websites focused on user experience and performance with meticulous attention to detail.</h1>
