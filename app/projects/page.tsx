...
export default function ProjectsPage() {
  return (
    <main className="px-8 my-12 lg:px-0 max-w-2xl mx-auto w-fit">
      ...
      <p className="tracking-tight leading-7 text-[15px] mt-4 mb-6 lg:leading-7 max-w-3xl">Here you can find the most important projects to me. Althought I&apos;ve worked on some others, these are my favorites.</p>
