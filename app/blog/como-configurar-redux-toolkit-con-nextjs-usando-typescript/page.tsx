  ...
  return (
    <main className="px-8 my-12 lg:px-0 max-w-2xl mx-auto">
      ...
      <div className="mt-4 tracking-tight border-b pb-2">
        <p className="text-[13px] text-neutral-600">Written by <a className="hover:underline" target="blank" href="https://medium.com/@khizerrehandev/how-to-configure-redux-toolkit-with-nextjs-using-typescript-384531fa7501">khizerrehandev</a>. Translated from English by Gabriel Maestre</p>
      </div>

      <p className="tracking-tight leading-7 text-[15px] mt-4 mb-6 text-neutral-600">Es importante tener en cuenta que esta configuración funciona con Next.js 14 (App Router), por lo que también funciona para Next.js 13. </p>

      <TitleWithText title="Crear un proyecto nuevo">
      ...
      <TitleWithText title="Intalar dependencias">
      ...
      <TitleWithText title="Configurar el store">
      ...
      <TitleWithText title="Definir los hooks useDispatch y useSelector">
        <p>Para ello crearemos un archivo llamado hooks.ts</p>
        <BlockCode filename="app/store/hooks.ts" lang="typescript" code={hooksCode} />
      </TitleWithText>

      <TitleWithText title="¿Qué son y cómo se configuran los slices?">
      ...
      <TitleWithText title="Configurar un Provider">
      ...
      <TitleWithText title="Envolver el root layout con el Provider">
      ...
      <TitleWithText title="Acceder al Store en cualquier componente">
      ...
      <TitleWithText title="Conclusión">
